...
class Snake:
    def __init__(self):
        self.body_size = BODYPATS
        self.coordinates = []
        self.squares = []

        for i in range(0, BODYPATS):
...
def game_over():
    ...
    canvas.create_text(canvas.winfo_width()/2, canvas.winfo_height()/2,font=('Comic sans MS',70),text='GAME OVER', fill='red',tag='game over')
